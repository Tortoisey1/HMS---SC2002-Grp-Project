...
public class AppointmentController implements AppointmentInterface {
    ...
    @Override
    public boolean bookAppointment(int dateOfTreatment, int month, int option, String patientId, String treatment,
            String doctorID) {
    ...
    public ArrayList<Appointment> getAppointmentsForPatient(String patientId, int filterOption) {
        ArrayList<Appointment> filteredList = new ArrayList<Appointment>();
    ...
    public boolean updateAppointment(Appointment appointment, String newInput, int choice) {
        if (choice == 1) {
            ...
            LocalDate date = LocalDate.of(LocalDate.now().getYear(), appointment.getMonthOfAppointment(),
